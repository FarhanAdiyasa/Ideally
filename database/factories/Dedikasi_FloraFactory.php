...
class Dedikasi_FloraFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'harga_b2I_31' => $this->faker->randomFloat(2, 10, 100),
            'harga_b2I_11' => $this->faker->randomFloat(2, 10, 100),
            'harga_b2I_1' => $this->faker->randomFloat(2, 10, 100),
            'harga_b2B_31' => $this->faker->randomFloat(2, 10, 100),
            'harga_b2B_11' => $this->faker->randomFloat(2, 10, 100),
