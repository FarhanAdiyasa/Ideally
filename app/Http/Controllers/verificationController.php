...
class verificationController extends Controller
{
    ...
    public function verify(EmailVerificationRequest $request){
        ...
        if ($request->user()->hasVerifiedEmail()) {
            ...
            // Redirect ke halaman dashboard dengan ID pengguna setelah verifikasi berhasil
            return redirect("auth/dashboard/$userId")->with('success', 'Email successfully verified.');
        }
