            ...
            <div class="col-sm-4">
                ...
                <section id="aside" class="border border-3 border-secondary p-3 py-4">
                    ...
                    <div id="carousel-image" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER1A 1.png') }}"
                    ...
                    <div id="carousel-image" class="carousel slide mt-4 pt-2" data-bs-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER2A 1.png') }}"
                                    class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER2A 1.png') }}"
                    ...
                    <div id="carousel-image" class="carousel slide mt-4 pt-2" data-bs-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER3A 1.png') }}"
                                    class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER3A 1.png') }}"
                    ...
                    <div id="carousel-image" class="carousel slide mt-4 pt-2" data-bs-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER4A 1.png') }}"
                                    class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER4A 1.png') }}"
                    ...
                    <div id="carousel-image" class="carousel slide mt-4 pt-2" data-bs-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER5A 1.png') }}"
                                    class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset ('shineage/assets/img/10B-SEC02-SLIDER5A 1.png') }}"
                    ...
                    <div class="d-flex h-100 flex-column justify-content-between">
                        <div class="row g-3 mb-3" style="height: 100%; overflow: hidden;">
                            <div class="col-sm-4">
                                <!-- Red Section -->
                                <section id="red">
                                    @foreach($shineages->take(7) as $merah)
                            ...
                            <div class="col-sm-4">
                                ...
                                <section id="tosca">
                                    ...
                                    @foreach($shineages->slice(7, 7) as $hijau)
                            ...
                            <div class="col-sm-4">
                                ...
                                <section id="yellow">
                                    ...
                                    @foreach($shineages->slice(14, 7) as $kuning)
                                    <div class="card-product mt-3">
                        ...
                        <div class="flex-start bg-grey" style="height: 30px;">
                            <div class="d-flex justify-content-center align-items-center">
                            {{ $shineages->links('partials.shineage-pagination') }}
                            </div>
                        </div>
                    </div>
                </section>
