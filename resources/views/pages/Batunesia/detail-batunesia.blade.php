...
<div class="card card-solid">
    <div class="card-body">
        <div class="container">
            <div class="row">
                <div class="col-6">
                <h3 class="d-inline-block d-sm-none">{{$batunesia->nama_produk}}</h3>
                <div class="col-12">
                ...
                <div class="col-12 product-image-thumbs">
                    ...
                    @endif
                    @if($batunesia->gambar_4 )
                        <div class="product-image-thumb active">
                            <img src="{{ asset('storage/' . $batunesia->gambar_4) }}" alt="Product Image">
                        </div>
                    @endif
                    @if($batunesia->gambar_5 )
                        <div class="product-image-thumb active">
                            <img src="{{ asset('storage/' . $batunesia->gambar_5) }}" alt="Product Image">
                        </div>
                    @endif
                </div>
                </div>
                <div class="col-6">
                <h3 class="my-3">{{$batunesia->nama_produk}}</h3>
