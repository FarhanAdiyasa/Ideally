  ...
  <div class="card card-default">
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="form-group">
              <input id="default2" type="text" class="form-control" placeholder="Placeholder text" name="nama_lokal" id="nama_lokal" value="{{old('nama_lokal')}}">
              @error('nama_lokal')
              <small class="text-danger">{{ $message }}</small>
              @enderror
              <div class="float-right d-none d-sm-block">
        ...
        <div class="col-12 col-sm-6">
          <div class="form-group">
            <label>Berat (gr)</label>
              <input type="number" class="form-control" placeholder="Placeholder text" name="berat_gram" value="{{old('berat_gram')}}">
                 @error('berat_gram')
              <small class="text-danger">{{ $message }}</small>
              @enderror
          </div>
