...
=======
    <div
        style="width: 1260px; height: 250px; padding-right: 1px;  align-items: center; gap: 290px; display: inline-flex">

        <div id="burgerContainer">
            <button id="burgerButton">
                <img style="width: 35px; height: 28px; margin-top: 50px; margin-right: 200px;"
                    src="../img/burger.png" />
            </button>
            <img style="width: 250px; height: 80px; margin-top: 30px; margin-right: 150px;"
                src="../img/Batunesia-Logo.png" />
            <div class="PopupSearch" id="popupSearch">
                <div class="Rectangle201"></div>
                <input type="text" class="Rectangle80" id="searchInput">
                <div class="Pencarian">Pencarian...</div>
...
=======
    ...
    <div class="Header" style="width: 1260px; height: 250px; position: relative">
        <img style="width: 1260px; height: 250px; left: 0px; top: 0px; position: absolute" src="../img/headline.png" />
        <div
            style="width: 775px; height: 141px; left: 70px; top: 41px; position: absolute; color: white; font-size: 60px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
            Pilih Yang Terbaik.</div>
        <div
            style="width: 822px; height: 35px; left: 70px; top: 147px; position: absolute; color: white; font-size: 25px; font-family: Bison; font-weight: 300; word-wrap: break-word">
            KAMI TAWARKAN PRODUK TERBAIK DARI YANG TERBAIK UNTUK ANDA.</div>
    </div>
    ...
    <div class="Group235" style="width: 237px; height: 250px; position: relative">
        <div class="Rectangle75"
            style="width: 237px; height: 250px; left: 265px; top: -485px; position: absolute; background: #101624">
            <div
                style="left: 30px; top: 30px; position: absolute; color: white; font-size: 18px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
                Deskripsi Produk</div>
            <div
                style="width: 177px; left: 30px; top: 77px; position: absolute; color: white; font-size: 14px; font-family: Poppins; font-weight: 400; word-wrap: break-word">
                @if(isset($selectedProduct))
                {{ $selectedProduct->deskripsi_singkat }}
                @else
                Product details not found.
        ...
        <div class="Group237" style="width: 237px; height: 250px; left: 265px;  top: -205px; position: relative ">
            <div class="Rectangle75"
                style="width: 237px; height: 250px; left: 0px; top: 0px; position: absolute; background: #101624"></div>
        ...
        <div class="Group236" style="width: 237px; height: 530px; top : -735px; left: 530px; position: relative">
            <div class="Rectangle75"
                style="width: 237px; height: 530px; left: 0px; top: 0px; position: absolute; background: #101624"></div>
            <div class="DaftarHarga"
                style="left: 30px; top: 30px; position: absolute; color: white; font-size: 18px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
                Daftar Harga</div>
            <div class="Button" style="width: 188.81px; height: 71px; left: 30px; top: 246px; position: absolute">
                <div class="Rectangle80"
                    style="width: 188.81px; height: 50px; left: 0px; top: 21px; position: absolute; border: 3px white solid">
                </div>
                <div class="Rp100000"
                    style="width: 118.35px; height: 33.75px; left: 35px; top: 29px; position: absolute; text-align: center; color: white; font-size: 16px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
                    Rp 100,000</div>
                <div class="10Satuan"
                    style="left: 0px; top: 0px; position: absolute; color: white; font-size: 14px; font-family: Poppins; font-weight: 400; word-wrap: break-word">
                    1-10 satuan</div>
            </div>
            <div class="Button" style="width: 188.81px; height: 71px; left: 30px; top: 337px; position: absolute">
                <div class="Rectangle80"
    ...
    <div class="Group230" style="width: 492px; height: 250px; top: -170px; left: -385px; position: relative">
        <img class="CSec02Latar1" style="width: 492px; height: 250px; left: 0px; top: 0px; position: absolute"
            src="../img/back.png" />
        <div class="BatuKoralPutihEngkel"
            style="width: 432px; left: 30px; top: 29px; position: absolute; color: white; font-size: 30px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
            @if(isset($selectedProduct))
            {{ $selectedProduct->nama_produk }}
            @else
            Product details not found.
            @endif</div>
        <div class="KategoriWarnaDimensi"
            style="left: 30px; top: 140px; position: absolute; color: white; font-size: 18px; font-family: Poppins; font-weight: 400; word-wrap: break-word">
            Kategori<br />Warna<br />Dimensi</div>
        <div class="BatuHiasAbuAbuD30Cm"
            style="left: 126px; top: 140px; position: absolute; color: white; font-size: 18px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
            @if(isset($selectedProduct))
            {{ $selectedProduct->kategori }}
            @else
            Product details not found.
    ...
    <div class="Group231" style="width: 748px; height: 250px; left: 300px; top: -400px; position: relative">
        <div class="MaskGroup" style="width: 748px; height: 250px; left: 0px; top: 0px; position: absolute">
            <div class="Preview" style="width: 748px; height: 250px; left: 0px; top: 0px; position: absolute;"></div>
            <div class="Rectangle86"
                style="width: 800px; height: 260px; left: -34.25px; top: -27.50px; position: absolute; background: #F35453">
            </div>
        </div>

        <div class="TambahKeKeranjang"
            style="left: 37px; top: 30px; position: absolute; color: white; font-size: 30px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
            Tambah<br />Ke Keranjang</div>
        <div class="Group481" style="width: 323.88px; height: 77.27px; left: 406px; top: 30px; position: absolute">
            <div class="VolumePembelian"
                style="left: 0px; top: 0px; position: absolute; color: white; font-size: 14px; font-family: Poppins; font-weight: 400; word-wrap: break-word">
                Volume Pembelian</div>

            <div class="Button" onclick="updateQuantity('-')"
                style="width: 56.27px; height: 56.27px; left: 0px; top: 21px; position: absolute; cursor: pointer;">
                <div class="Rectangle80"
                    style="width: 56.27px; height: 56.27px; left: 0px; top: 0px; position: absolute; background: white">
                </div>
                <div
                    style="left: 20.61px; top: 8px; position: absolute; text-align: center; color: #F35453; font-size: 25px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
                    -</div>
            </div>

            <div class="Button" style="width: 112.54px; height: 56.27px; left: 69px; top: 21px; position: absolute">
                <div class="Rectangle80"
                    style="width: 112.54px; height: 56.27px; left: 0px; top: 0px; position: absolute; border: 3px white solid">
                </div>
                <div id="quantity"
                    style="left: 48px; top: 8px; position: absolute; text-align: center; color: white; font-size: 25px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
                    1</div>
            </div>

            <div class="Button" onclick="updateQuantity('+')"
                style="width: 56.27px; height: 56.27px; left: 197px; top: 21px; position: absolute; cursor: pointer;">
                <div class="Rectangle80"
                    style="width: 56.27px; height: 56.27px; left: 0px; top: 0px; position: absolute; background: white">
                </div>
                <div
                    style="left: 20px; top: 8px; position: absolute; text-align: center; color: #F35453; font-size: 25px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
                    +</div>
            </div>

            <div class="Button" id="myButton"
                style="width: 56.27px; height: 56.27px; left: 270px; top: 21px; position: absolute; cursor: pointer;">
                <a id="myLink"
                    href="{{ route('tambahKeKeranjang', ['id_batu' => $selectedProduct->id_batu, 'quantity' => '1']) }}">
                    <div class="Rectangle80"
                        style="width: 56.27px; height: 56.27px; left: 0px; top: 0px; position: absolute; background: white">
                    </div>
                    <div
                        style="left: 10px; top: 8px; position: absolute; text-align: center; color: #F35453; font-size: 25px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
    ...
    <div class="Button" style="width: 324px; height: 77px; left: 406px; top: 144px; position: absolute">
        <div class="Rectangle80"
            style="width: 323px; height: 56px; left: 1px; top: 21px; position: absolute; border: 3px white solid"></div>
        <div class="Rp1000000" id="totalPrice"
            style="left: 104px; top: 35px; position: absolute; text-align: center; color: white; font-size: 18px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
        </div>
    ...
    // Assuming you have a variable 'productPrice' representing the price of the product
    var productPrice =
    <?= $selectedProduct->{'harga_b2I_31+_unit'} ?? 0; ?>; // Replace this with your actual logic to fetch product price
    ...
    <div class="Group474" style="width: 236px; height: 250px; left: -512px; top: -370px; position: relative">
        <div class="Rectangle101"
            style="width: 236px; height: 250px; left: 0px; top: 0px; position: absolute; background: #101624"></div>
        <div class="ProdukTerkait"
            style="width: 144px; height: 50.38px; left: 32px; top: 10.46px; position: absolute; color: white; font-size: 35px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
            Produk Terkait</div>

        <div class="Slider" style="width: 55px; height: 30px; left: 158px; top: 197px; position: absolute">
            <div class="Rectangle83"
                style="width: 15px; height: 15px; left: 0px; top: 15px; position: absolute; background: white"></div>
            <div class="Rectangle84"
                style="width: 15px; height: 30px; left: 20px; top: 0px; position: absolute; background: white"></div>
            <div class="Rectangle85"
                style="width: 15px; height: 15px; left: 40px; top: 15px; position: absolute; background: white"></div>
        </div>
    </div>
    ...
    <div style="width: 1004px; height: 1910px; left: 535px; top: 1438px; position: absolute">
        ...
        <div style="width: 100%; box-sizing: border-box; display: flex; flex-wrap: wrap; gap: 26.5px;">
            @forelse ($batunesias1 as $batunesia)
            <a href="{{ route('Detail-Batunesia', ['id_batu' => $batunesia->id_batu]) }}" class="product-card"
...
=======
    ...
    <div class="Group474" style="width: 236px; height: 250px; left: -512px; top: -300px; position: relative">
        ...
        <div class="ProdukRekomEndasi"
            style="width: 162px; height: 148px; left: 32px; top: 10px; position: absolute; color: white; font-size: 35px; font-family: Poppins; font-weight: 700; word-wrap: break-word">
            Produk Rekom-endasi</div>
    ...
    <div class="Footer" style="width: 1920px; height: 243px; position: relative">
        <div class="Rectangle8"
            style="width: 1920px; height: 243px; left: 0px; top: 0px; position: absolute; background: #303030"></div>
        <div class="Group576" style="width: 407px; height: 40px; left: 757px; top: 143px; position: absolute">
            <a href="https://web.whatsapp.com/" class="ButtonWA clickable"
                style="width: 257px; height: 40px; left: 150px; top: 0px; position: absolute">
                <div class="Rectangle16"
                    style="width: 257px; height: 40px; left: 0px; top: 0px; position: absolute; background: #06C195; border-radius: 30px">
                </div>
                <div class="InformasiLebihLanjut"
                    style="width: 213px; left: 44px; top: 9px; position: absolute; color: white; font-size: 18px; font-family: Arial; font-weight: 700; word-wrap: break-word">
                    Informasi Lebih Lanjut</div>
                <img class="LogoWa1" style="width: 20px; height: 20px; left: 12px; top: 10px; position: absolute"
                    src="../img/LogoWA.png" />
            </a>

            <a href="https://www.linkedin.com/" class="ButtonLinkedin clickable"
                style="width: 40px; height: 40px; left: 100px; top: 0px; position: absolute">
                <div class="Ellipse33"
                    style="width: 40px; height: 40px; left: 0px; top: 0px; position: absolute; background: #06C195; border-radius: 9999px">
                </div>
                <img class="LogoLinkedin1" style="width: 20px; height: 20px; left: 10px; top: 10px; position: absolute"
                    src="../img/LinkedinLogo.png" />
            </a>

            <a href="https://www.tiktok.com/" class="ButtonTiktok clickable"
                style="width: 40px; height: 40px; left: 50px; top: 0px; position: absolute">
                <div class="Ellipse34"
                    style="width: 40px; height: 40px; left: 0px; top: 0px; position: absolute; background: #06C195; border-radius: 9999px">
                </div>
                <img class="LogoTiktok1" style="width: 20px; height: 20px; left: 10px; top: 10px; position: absolute"
                    src="../img/LogoTiktok.png" />
            </a>

            <a href="https://www.instagram.com/" class="ButtonIG clickable"
                style="width: 40px; height: 40px; left: 0px; top: 0px; position: absolute">
                <div class="Ellipse35"
                    style="width: 40px; height: 40px; left: 0px; top: 0px; position: absolute; background: #06C195; border-radius: 9999px">
                </div>
                <img class="LogoIg1" style="width: 20px; height: 20px; left: 10px; top: 10px; position: absolute"
                    src="../img/LogoIG.png" />
            </a>
        </div>
        <div style="width: 612px; left: 654px; top: 70px; position: absolute; text-align: center"><span
                style="color: white; font-size: 20px; font-family: Montserrat; font-weight: 700; word-wrap: break-word">©
                PT Lanskap Indonesia Ideal </span><span
                style="color: white; font-size: 20px; font-family: Montserrat; font-weight: 400; word-wrap: break-word">2023.</span>
        </div>
    </div>
>>>>>>> d5557992f1c905b8f774d6907a37c029ef4d4590
