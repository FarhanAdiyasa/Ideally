                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="deskripsi text-white">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu massa gravida,
                                pellentesque felis nec, tristique leo. Nam eu massa gravida, pellentesque felis nec,
                                tristique leo. Nam eu massa gravida, pellentesque felis nec, tristique leo.</p>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-left">
                    ...
                    <section id="seri-unggulan" class="padding-left-side">
                        ...
                        <div class="mb-3 card-seri-unggulan">
                            <div class="row g-0">
                                <div class="col-md-2">
                                    <img src="../img/LOGO MojaPisun.png" class="img-fluid" alt="...">
                                </div>
                                <div class="col-md-10">
                                    <div class="card-body">
                                        <p class="card-text title">Industrial Style</p>
                                        <p class="card-text deskripsi">Lorem ipsum dolor sit amet consectetur
                                            adipisicing elit. Dolore unde esse voluptatem laborum sapiente.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex">
                            <div class="mb-3 card-jaminan">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-10">
                                        <div class="card-body">
                                            <p class="card-text deskripsi">Lorem, ipsum dolor sit amet consectetur adipisicing.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="overview">
                            ...
                            <div class="deskripsi">
                                <p>Everlas Things, perintis keanggunan dalam furniture logam. Dengan fokus pada material
                                    logam, kami hadirkan desain unik dan kualitas terbaik untuk suasana ruang Anda.
                                    Setiap produk mencerminkan keabadian, menggabungkan keindahan seni dan
                                    fungsionalitas yang tahan lama. Dari bangku hingga ornamen, Everlas Things
                                    menciptakan suasana ruang yang memukau dan memenuhi keinginan estetika dan
                                    kenyamanan.</p>
                            </div>
